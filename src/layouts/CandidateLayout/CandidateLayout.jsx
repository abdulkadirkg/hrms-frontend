          ...
          <div className="col-12 d-flex flex-column align-items-center mb-3 justify-content-center">
            ...
            <h3 className="font-weight-bold mb-0">
              ...
              {!candidate.confirmationByStaff.confirmed && (
                <svg aria-hidden="true" width="20" focusable="false" data-prefix="fas" data-icon="badge-check" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="svg-inline--fa fa-badge-check fa-w-16">
